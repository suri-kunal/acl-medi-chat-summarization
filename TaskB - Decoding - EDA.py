...
# %%
api = wandb.Api()
entity, project = "kunal-suri-ml-experiments", "TaskB-metric-optimization-hpo-with-rouge-and-ertscore"  # set to your entity and project 
...
# %%
score_df_6 = score_df_6.loc[score_df_6.index < 22]
score_df_6
...
with open("taskb_summary_configuration_max.json","w") as f:
